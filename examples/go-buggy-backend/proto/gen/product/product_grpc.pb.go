...
// Intentional bug: GetProduct returns a wrong price for product id=1.
...
const (
	InventoryService_CheckStock_FullMethodName = "/product.InventoryService/CheckStock"
)
...
// Intentional bug: this service is declared in the proto but NOT implemented
// by the server, so gRPC reflection should report it as missing.
type InventoryServiceClient interface {
	// CheckStock returns the stock level for a product.
	CheckStock(ctx context.Context, in *CheckStockRequest, opts ...grpc.CallOption) (*Stock, error)
}
...
func (c *inventoryServiceClient) CheckStock(ctx context.Context, in *CheckStockRequest, opts ...grpc.CallOption) (*Stock, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Stock)
...
type InventoryServiceServer interface {
	// CheckStock returns the stock level for a product.
	CheckStock(context.Context, *CheckStockRequest) (*Stock, error)
...
func (UnimplementedInventoryServiceServer) CheckStock(context.Context, *CheckStockRequest) (*Stock, error) {
...
var InventoryService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "product.InventoryService",
